...
import Appbar from "./Components/TeacherAppbar";
...
export default function BasicTextFields() {
  ...
  const handleSubmit = () => {
    ...
    const result = { name, email, slot };
    fetch("http://localhost:8080/slot/add-teacherslot", {
      method: "POST",
    ...
    <div>
      ...
      >
        <Box
          ...
          autoComplete="off"
        >
          <h1 style={{ textAlign: "center", marginTop: "20px",  fontFamily:"cursive"}}>
            REVIEWERS SLOT BOOKING
          </h1>
              ...
              <Grid item xs={12}>
                <FormControl fullWidth>
                  ...
                  >
                   ...
                   {showslot.date} - {showslot.time}</MenuItem>
                   ))}
                  </Select>
                </FormControl>
                <br />
